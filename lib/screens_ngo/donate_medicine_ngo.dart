...
class DonateMedicineNgo extends StatefulWidget {
  @override
  State<DonateMedicineNgo> createState() => _DonateMedicineNgoState();
}

class _DonateMedicineNgoState extends State<DonateMedicineNgo> {
